OC.L10N.register(
    ...
    "No file(s) selected." : "Herhangi bir dosya seçilmemiş.",
    "MIME type(s) not supported." : "MIME türleri desteklenmiyo",
    ...
    "No languages available for OCR processing. Please make sure to setup tesseract and OCRmyPDF correctly." : "OCR işlemi için kullanılabilecek bir dil yok. Lütfen tesseract ve OCRmyPDF uygulamalarının doğru ayarlandığından emin olun.",
    ...
    "Cannot delete temporary file during temp file creation for tesseract." : "Dört boyutlu küp için geçici dosya oluşturulurken geçici dosya silinemedi.",
    "Cannot create temporary file for tesseract." : "Dört boyutlu küp için geçici dosya oluşturulamadı.",
    "Cannot set permissions to temporary file for tesseract." : "Dört boyutlu küp için geçici dosya izinleri ayarlanamadı.",
