OC.L10N.register(
    ...
    "An unexpected error occurred during the load of your favorite languages. No language will be set instead." : "An unexpected error occurred during the load of your favourite languages. No language will be set instead.",
