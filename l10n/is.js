OC.L10N.register(
    ...
    {
    "Saved." : "Vistað.",
    "Saving languages failed:" : "Vistun tungumála mistókst:",
    "The languages are not specified in the correct format." : "Tungumálin eru ekki skilgreind á réttu sniði.",
    "Saving Redis settings failed:" : "Vistun Redis-stillinga mistókst:",
    "The Redis settings are not specified in the right format." : "Redis-stillingarnar eru ekki skilgreindar á réttu sniði.",
    "OCR" : "OCR-ljóslestur",
    ...
    "OCR status could not be retrieved:" : "Tókst ekki að ná í stöðu OCR-ljóslesturs:",
    "No languages available for OCR processing. Please make sure to configure the languages in the administration section." : "Engin tungumál eru tiltæk fyrir OCR-vinnslu. Gakktu úr skugga um að tungumál séu sett upp í stjórnunarhlutanum.",
    ...
    "OCR jobs could not be retrieved:" : "Tókst ekki að ná í stöðu OCR-ljóslestrarverka:",
    "The job for the following file object has been successfully deleted:" : "Verki fyrir eftirfarandi skrá hefur verið eytt:",
    ...
    "Status" : "Staða",
    "Log" : "Annáll",
    "Replace by result" : "Skipta út eftir niðurstöðum",
    "Saved" : "Vistað",
