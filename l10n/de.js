OC.L10N.register(
    ...
    "_Replace (PDF) or delete (image) orignal file_::_Replace (PDF) or delete (images) orignal files_" : ["Ersetze (PDF) oder lösche (Bild) die Ursprungsdatei","Ersetze (PDF) oder lösche (Bilder) die Ursprungsdateien"],
