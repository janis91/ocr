OC.L10N.register(
    ...
    "Saving Redis settings failed:" : "Lagring av Redis-innstillinger mislyktes:",
    ...
    "Status" : "Status",
    "Log" : "Logg",
    "Replace by result" : "Erstatt av resultat",
    "Saved" : "Lagret",
    ...
    "The Redis DB is not specified in the correct format." : "Redis DB er ikke oppgitt i riktig format.",
    "Wrong parameter." : "Feil parameter.",
    "Wrong MIME type." : "Feil MIME-type.",
    "Cannot replace shared files." : "Kan ikke erstatte delte filer.",
    ...
    "Reading the finished jobs from Redis went wrong." : "Lesing av fullførte jobber fra Redis gikk galt.",
    "Temp file does not exist." : "Midlertidig fil finnes ikke.",
    "OCR could not put processed file to the right target folder. If you selected the replace option, you can restore the file by using the trash bin." : "OCR kunne ikke legge behandlet fil i riktig målmappe. Hvis du valgte erstatt -valget, kan du gjenopprette filen ved å bruke papirkurven.",
