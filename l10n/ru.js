OC.L10N.register(
    ...
    "Mimetype(s) not supported." : "Тип(ы) MIME не поддерживаются.",
    ...
    "Name" : "Имя",
    "Status" : "Статус",
    "Following status object has been successfully deleted:" : "Указанный объект состояния был успешно удалён:",
