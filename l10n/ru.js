OC.L10N.register(
    ...
    "An unexpected error occured during the load of your favorite languages. No language will be set instead." : "Не удалось загрузить список избранных языков, язык для распознавания не установлен.",
    "An unexpected error occured during the upload of the processed file." : "Не удалось передать обработанный файл.",
    "An unexpected error occured during the deletion of the original file." : "Не удалось удалить исходный файл.",
    "An unexpected error occured during Tesseract processing." : "Неожиданная ошибка во время работы программы Tesseract",
