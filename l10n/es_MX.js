OC.L10N.register(
    ...
    "_OCR started: %n new file in queue._::_OCR started: %n new files in queue._" : ["Comenzó el OCR: %n archivo nuevo en la cola","Comenzó el OCR: %n archivos nuevos en la cola"],
