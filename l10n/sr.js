OC.L10N.register(
    ...
    "Process" : "Обради",
    "Replace" : "Замени",
    "_OCR started: %n new file in queue._::_OCR started: %n new files in queue._" : ["OCR почео: %n нови фајл на чекању.","OCR почео:  %n нова фајла на чекању.","OCR почео:  %n нових фајлова на чекању."],
    "_OCR: %n currently pending file in queue._::_OCR: %n currently pending files in queue._" : ["OCR: тренутно %n  фајл чека","OCR: тренутно %n фајла чекају","OCR: тренутно %n фајлова чека"],
