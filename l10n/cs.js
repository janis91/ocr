OC.L10N.register(
    ...
    "An unexpected error occurred during the load of your favorite languages. No language will be set instead." : "Došlo k neočekávané chybě při načítání vašich oblíbených jazyků. Namísto toho nebude nastaven žádný jazyk.",
    "An unexpected error occurred during the upload of the processed file." : "Při nahrávání zpracovaného souboru došlo k neočekávané chybě.",
    "An unexpected error occurred during the deletion of the original file." : "Při mazání původního souboru došlo k neočekávané chybě.",
    "An unexpected error occurred during Tesseract processing." : "Při zpracovávání v Tesseract došlo k neočekávané chybě.",
