OC.L10N.register(
    ...
    {
    "Saved." : "Zapisano.",
    "Saving languages failed:" : "Zapisywanie języków nie powiodło się:",
    "The languages are not specified in the correct format." : "Języki nie są podane we właściwym formacie.",
    "Saving Redis settings failed:" : "Nie udało się zapisać ustawień Redis:",
    "The Redis settings are not specified in the right format." : "Ustawienia Redis nie są określone we właściwym formacie.",
    "OCR" : "OCR",
    ...
    "OCR status could not be retrieved:" : "Nie można pobrać statusu OCR:",
    "No languages available for OCR processing. Please make sure to configure the languages in the administration section." : "Brak dostępnych języków do przetwarzania OCR. Proszę upewnić się, czy można skonfigurować języki w sekcji administracyjnej.",
    "Available languages could not be retrieved:" : "Nie można pobrać dostępnych języków:",
    "Process" : "Proces",
    "Replace" : "Zastąpić",
    "_OCR started: %n new file in queue._::_OCR started: %n new files in queue._" : ["OCR wystartował: %n nowy plik w kolejce.","OCR wystartował: %n nowych plików w kolejce.","OCR wystartował: %n nowych plików w kolejce.","OCR wystartował: %n nowych plików w kolejce."],
    "_OCR: %n currently pending file in queue._::_OCR: %n currently pending files in queue._" : ["OCR: %n plik oczekuje aktualnie w kolejce.","OCR: %n plików oczekuje aktualnie w kolejce.","OCR: %n plików oczekuje aktualnie w kolejce.","OCR: %n plików oczekuje aktualnie w kolejce."],
    "No matches found." : "Nie znaleziono żadnego wyniku.",
    "Select language" : "Wybierz język",
    "OCR jobs could not be retrieved:" : "Nie można pobrać zadań OCR:",
    "The job for the following file object has been successfully deleted:" : "Zadanie dla następującego obiektu pliku zostało pomyślnie usunięte:",
    "Error during deletion:" : "Błąd podczas usuwania:",
    "Delete" : "Usuń",
    "No pending or failed OCR items found." : "Nie znaleziono oczekujących lub nieudanych elementów OCR.",
    "Refresh" : "Odśwież",
    "Delete from queue" : "Usuń z kolejki",
    "File" : "Plik",
    "Status" : "Status",
    "Log" : "Log",
    "Replace by result" : "Zastąp według wyniku",
    "Saved" : "Zapisano",
