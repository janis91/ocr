OC.L10N.register(
    "ocr",
    {
    "OCR App could not be initialized:" : "Aplikacja OCR nie może zostać zainicjowana:",
    "Files have wrong mimetypes." : "Pliki mają niewłaściwe typy MIME.",
    "Name" : "Nazwa",
    "Status" : "Status",
    ...
    "Refresh" : "Odśwież",
    "Following file has been successfully deleted from the queue:" : "Następujący plik został poprawnie usunięty z kolejki:",
    "Error during deletion: " : "Błąd podczas kasowania:",
    "No languages for tesseract available" : "Brak dostępnych języków dla oprogramowania tesseract",
    "Process" : "Postęp",
    "OCR" : "OCR",
    ...
    "Wrong mimetype." : "Błędny typ MIME pliku.",
    "Temp file does not exist." : "Plik tymczasowy nie istnieje.",
    "Could not add files to the ocr processing queue." : "Nie można dodać plików do kolejki OCR."
},
