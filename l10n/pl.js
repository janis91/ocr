OC.L10N.register(
    ...
    "_Replace (PDF) or delete (image) orignal file_::_Replace (PDF) or delete (images) orignal files_" : ["Zastąp (PDF) lub usuń oryginalny plik (obraz)","Zastąp (PDF) lub usuń oryginalne pliki (obrazy)","Zastąp (PDF) lub usuń oryginalne pliki (obrazy)","Zastąp (PDF) lub usuń oryginalne pliki (obrazy)"],
