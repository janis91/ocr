OC.L10N.register(
    ...
    "No file(s) selected." : "Nie wybrano plików.",
    "Mimetype(s) not supported." : "Typ MIME nie jest wspierany.",
    ...
    "No languages available for OCR processing. Please make sure to setup tesseract and OcrMyPdf correctly." : "Brak dostępnych języków do przetwarzania OCR. Upewnij się, że ustawienia Tesseract oraz OcrMyPdf są prawidłowe.",
    ...
    "Name" : "Nazwa",
    "Status" : "Status",
    "Following status object has been successfully deleted:" : "Następujący status obiektu został usunięty z sukcesem:",
