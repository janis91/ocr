OC.L10N.register(
    ...
    "An unexpected error occurred during the load of your favorite languages. No language will be set instead." : "Ein unerwarteter Fehler trat während des Ladens Ihrer favorisierten Sprachen auf. Stattdessen wird keine Sprache gesetzt.",
    "An unexpected error occurred during the upload of the processed file." : "Ein unerwarteter Fehler trat während des Hochladens der verarbeiteten Datei auf.",
    ...
    "An unexpected error occurred during Tesseract processing." : "Ein unerwarteter Fehler trat bei der Verarbeitung durch Tesseract auf.",
