OC.L10N.register(
    ...
    "_Replace (PDF) or delete (image) orignal file_::_Replace (PDF) or delete (images) orignal files_" : ["Ersetzen (PDF) oder löschen (Bild) der Ursprungsdatei","Ersetzen (PDF) oder löschen (Bilder) der Ursprungsdateien"],
