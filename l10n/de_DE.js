OC.L10N.register(
    ...
    "_OCR processing for %n file failed. For details please go to your personal settings._::_OCR processing for %n files failed. For details please go to your personal settings._" : ["Texterkennung für %n Datei fehlgeschlagen. Für weitere Informationen sehen Sie in Ihren persönlichen Einstellungen nach.","Texterkennung für %n Dateien fehlgeschlagen. Für weitere Informationen sehen Sie in Ihren persönlichen Einstellungen nach."],
    ...
    "OCR could not put processed file to the right target folder. If you selected the replace option, you can restore the file by using the trash bin." : "OCR kann die verarbeitete Datei nicht im richtigen Zielordner speichern. Wenn Sie die Überschreiben-Option gewählt haben, können Sie die Datei über den Papierkorb wiederherstellen.",
